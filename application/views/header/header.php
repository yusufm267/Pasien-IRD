  ...
  <link rel="stylesheet" href="<?=base_url()?>assets/vendor/adminlte/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  <!-- Daterange picker -->
  ...
  <link rel="stylesheet" href="<?=base_url()?>assets/vendor/adminlte/plugins/datatables-buttons/css/buttons.dataTables.min.css">
  <!-- Select2 -->
  ...
  <link rel="stylesheet" href="<?=base_url()?>assets/vendor/adminlte/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?=base_url()?>assets/vendor/adminlte/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="<?=base_url()?>assets/vendor/adminlte/plugins/dropzone/min/dropzone.min.css">
  ...
  <link rel="stylesheet" href="<?=base_url()?>assets/css/style.css?versi=2">
...
<!-- BS-Stepper -->
<script src="<?=base_url()?>assets/vendor/adminlte/plugins/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
<script src="<?=base_url()?>assets/vendor/adminlte/plugins/dropzone/min/dropzone.min.js"></script>
...
<script>
  //var base="<?=base_url()?>";
  //var user_token="<?=/*$this->ion_auth->user()->row()->token*/''?>";
</script>